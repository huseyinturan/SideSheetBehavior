...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
  ...
  public abstract static class SideSheetCallback {
    ...
    public abstract void onStateChanged(@NonNull View bottomSheet,
        @SideSheetBehavior.State int newState);
  ...
  public Parcelable onSaveInstanceState(CoordinatorLayout parent, V child) {
    return new SideSheetBehavior.SavedState(super.onSaveInstanceState(parent, child), this);
  }

  @Override
  public void onRestoreInstanceState(CoordinatorLayout parent, V child, Parcelable state) {
    SideSheetBehavior.SavedState ss = (SideSheetBehavior.SavedState) state;
  ...
  public void onStopNestedScroll(
    ...
    if (viewDragHelper.smoothSlideViewTo(child, child.getLeft(), top)) {
      ...
      ViewCompat.postOnAnimation(child, new SideSheetBehavior.SettleRunnable(child, targetState));
    } else {
   ...
   * or {@link #STATE_HALF_EXPANDED}.
   */
  public final void setState(@SideSheetBehavior.State int state) {
    @SideSheetBehavior.State int previousState = this.state;
    if (state == this.state) {
      return;
    }
    if (viewRef == null) {
  ...
  private void startSettlingAnimationPendingLayout(@SideSheetBehavior.State int state) {
  ...
  void setStateInternal(@SideSheetBehavior.State int state) {
  ...
  private void updateDrawableOnStateChange(@SideSheetBehavior.State int state,
      @SideSheetBehavior.State int previousState) {
  ...
  private void restoreOptionalState(
      SideSheetBehavior.SavedState ss) {
  ...
  void startSettlingAnimation(View child, int state) {
    ...
    if (viewDragHelper.smoothSlideViewTo(child, left, child.getTop())) {
      setStateInternal(STATE_SETTLING);
      ViewCompat.postOnAnimation(child, new SideSheetBehavior.SettleRunnable(child, state));
    } else {
  ...
  private final ViewDragHelper.Callback dragCallback =
      new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(@NonNull View releasedChild, float xvel, float yvel) {
          int left;
          @SideSheetBehavior.State int targetState;
          ...
          if (viewDragHelper.settleCapturedViewAt(left, releasedChild.getTop())) {
            ...
            ViewCompat.postOnAnimation(
                releasedChild, new SideSheetBehavior.SettleRunnable(releasedChild, targetState));
          } else {
            if (targetState == STATE_EXPANDED && interpolatorAnimator != null) {
              interpolatorAnimator.reverse();
            }
  ...
  private class SettleRunnable implements Runnable {
    ...
    SettleRunnable(View view, @SideSheetBehavior.State int targetState) {
      this.view = view;
  ...
  protected static class SavedState extends AbsSavedState {
    ...
    public static final Creator<SideSheetBehavior.SavedState> CREATOR =
        new ClassLoaderCreator<SideSheetBehavior.SavedState>() {
          @Override
          public SideSheetBehavior.SavedState createFromParcel(Parcel in, ClassLoader loader) {
            return new SideSheetBehavior.SavedState(in, loader);
          }

          @Override
          public SideSheetBehavior.SavedState createFromParcel(Parcel in) {
            return new SideSheetBehavior.SavedState(in, null);
          }
